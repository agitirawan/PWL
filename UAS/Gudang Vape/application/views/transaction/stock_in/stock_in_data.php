...
<section class="content">
    ...
    <div class="box">
         <div class="box-header">
            <h3 class="box-title">Data Transaksi Stok Masuk</h3>
                ...
                <?php $no = 1;
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                                ...
                                <?php if($this->fungsi->user_login()->level == 1) { ?>
                                <a href="<?=site_url('stock/in/del/' .$data->stock_id.'/'.$data->item_id)?>" onclick="return confirm('Apakah Ingin Menghapus Kategori? ')" class="btn btn-danger btn-xs">
