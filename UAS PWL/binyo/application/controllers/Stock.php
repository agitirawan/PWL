...
class Stock extends CI_Controller {
    ...
    public function stock_in_del()
    {
        ...
        if($this->db->affected_rows() > 0){
            echo "<script>alert('Data Stok Masuk Berhasil Di Hapus');</script>";
        }
    ...
    public function process()
    {
        if(isset($_POST['in_add'])){
            ...
            if($row_item->stock < $this->input->post('qty')){
                echo "<script>alert('ERROR!!! Qty Melebihi Stok');</script>";
    ...
    public function stock_out_del()
    {
        ...
        $this->stock_m->del($stock_id);
        if($this->db->affected_rows() > 0){
            echo "<script>alert('Data Stok Keluar Berhasil Di Hapus');</script>";
        }
